...
/*and all data flows*/ from//this single source.
	'cloudflare\u003asockets';
let config_JSON, 反代IP = 'cdn-all.xn--b6gac.eu.org', 启用SOCKS5反代 = null, 启用SOCKS5全局反代 = false, 我的SOCKS5账号 = '', parsedSocks5Address = {};
...
export default {
	async fetch(request, env, ctx) {
		...
		const userID = 'ad90a423-f3c9-43c3-9878-57d425f385c7';
